                            ...
                            <div class="modal-body" id="adminModalBody">
                                <div class="row">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <asp:TextBox ID="tbEmployeeCount" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <asp:Button runat="server" ID="adminModalSave" type="button" CssClass="btn btn-primary" Text="Save changes"></asp:Button>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
