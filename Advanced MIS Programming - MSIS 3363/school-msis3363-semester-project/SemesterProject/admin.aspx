...
<asp:Content ID="Administration" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    <div class="administration container">
        ...
        <!-- Modal is hidden until opened from the table -->
        <div class="modal fade" id="adminModal" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <asp:UpdatePanel ID="adminModalUpdatePanel" UpdateMode="Conditional" runat="server">
                        <ContentTemplate>
                            <div class="modal-header">
                                <h5 class="modal-title">
                                    <asp:Label runat="server" Text="" ID="adminModalTitle"></asp:Label>
                                </h5>
                            ...
                            <div class="modal-footer">
                                <div class="alert alert-danger invisible" runat="server" id="adminModalAlert">Test</div>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <asp:Button runat="server" ID="adminModalSave" OnClick="adminModalSave_Click" type="button" CssClass="btn btn-primary" Text="Save changes"></asp:Button>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
